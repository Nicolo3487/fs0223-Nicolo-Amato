...
container.innerHTML += `<label aria-label="${index} stars" class="rating__label" for="rating-${index}"><svg class="rating__icon--star" width="47" height="46" viewBox="0 0 47 46" xmlns="http://www.w3.org/2000/svg">
